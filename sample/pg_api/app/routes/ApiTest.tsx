        ...
        {contacts.map(item => (
          <li key={item.id} className="remix__page__resource">
            ...
            <a href={`/apitestshow?id=${item.id}`}>
              <button 
              className="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded ms-2"
              >Show</button>
            </a>
            <hr className="my-2" />
          </li>
